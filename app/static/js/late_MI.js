...
$("document").ready(function(){
    ...
    $("#helpIcon").click(function(){
        ...
        $("#botContainer").append("<div class='botMsg'>"+`<div class='botImg'><img src='/static/img/bot.jpg' height='40%' width='40%' alt='Bot'  /></div>`+"<div class='botText'>"+"The contexts will help you better understand how the conversation comes to the current turn <code>I might just take a walk or see my friends. But like I said, it seems like they don\u2019t want to be around me so much anymore because I bring them down with me. Do you have some suggestions on what I should do?</code> Shall we begin?"+"</div></div>");
    ...
    function callbackReply(replyBool, cxtTag){
        ...
        if (replyBool && cxtTag == "social_cxt_MI"){
            ...
            messageText = "Don't worry. You will get more information on the user and how to encourage the user to follow a plan. Keep following:)";
            ...
            messageText = `The highlighted texts you've seen on the left chat window show the relevant situation which the sentence <a href='#highlightCxt0' id='linkToCxt'>"friends"</a> refers to. How about you let me give you more context and then you can know better?`;
            contextBotSendMessage(messageText);
            setTimeout(()=>{
    ...
    function addCxtPrompts(cxtTag){
        switch (cxtTag){
            case "social_cxt_MI":
                messageText = `Your role is to act as a coach ${social_cxt_MI}. You need to strengthen the user's faith of following the plan. How does that sound to you?`;
                contextBotSendMessage(messageText);
                break;
            // add the link
            case "linguistic_cxt_MI":
                messageText1 = `First I guess you'd like to click <a href="#highlightCxt0" id="linkToCxt">"friends"</a> to see to which content it refers in the previous chat. Use <code>Back</code> <button class="back">Back</button> and <code>Next</code> <button class="next">Next</button> to navigate through multiple sentences.`;
